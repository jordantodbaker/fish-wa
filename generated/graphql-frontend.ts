...
export type CountiesQuery = {
  ...
  counties: Array<{
    ...
    name: string;
    shortName: string;
    lakes: Array<{ __typename?: "Lake"; id: number; name?: string | null }>;
  }>;
};
...
export type UpdateUserLakesMutation = {
  __typename?: "Mutation";
  updateUserLakes?: {
    __typename?: "UserLakes";
    userLakes: Array<number | null>;
  } | null;
};
...
export type UserQuery = {
  ...
  user?: {
    ...
    lakeIds?: Array<number | null> | null;
    lakes?: Array<{
      __typename?: "Lake";
      id: number;
      name?: string | null;
    } | null> | null;
    stockingReports?: Array<{
      __typename?: "StockingReport";
      lakeId?: number | null;
      name?: string | null;
      date?: string | null;
...
export function useCountiesQuery(
  baseOptions?: Apollo.QueryHookOptions<CountiesQuery, CountiesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<CountiesQuery, CountiesQueryVariables>(
    CountiesDocument,
    options
  );
}
export function useCountiesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<CountiesQuery, CountiesQueryVariables>(
    CountiesDocument,
    options
  );
}
export function useCountiesSuspenseQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<CountiesQuery, CountiesQueryVariables>(
    CountiesDocument,
    options
  );
}
export type CountiesQueryHookResult = ReturnType<typeof useCountiesQuery>;
export type CountiesLazyQueryHookResult = ReturnType<
  typeof useCountiesLazyQuery
>;
export type CountiesSuspenseQueryHookResult = ReturnType<
  typeof useCountiesSuspenseQuery
>;
export type CountiesQueryResult = Apollo.QueryResult<
  CountiesQuery,
  CountiesQueryVariables
>;
...
`;
export type UpdateUserLakesMutationFn = Apollo.MutationFunction<
  UpdateUserLakesMutation,
  UpdateUserLakesMutationVariables
>;
 ...
 * });
 */
export function useUpdateUserLakesMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateUserLakesMutation,
    UpdateUserLakesMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateUserLakesMutation,
    UpdateUserLakesMutationVariables
  >(UpdateUserLakesDocument, options);
}
export type UpdateUserLakesMutationHookResult = ReturnType<
  typeof useUpdateUserLakesMutation
>;
export type UpdateUserLakesMutationResult =
  Apollo.MutationResult<UpdateUserLakesMutation>;
export type UpdateUserLakesMutationOptions = Apollo.BaseMutationOptions<
  UpdateUserLakesMutation,
  UpdateUserLakesMutationVariables
>;
